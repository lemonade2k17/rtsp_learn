...
# If for some reason you wish to use the deprecated "gethostbyname()" function instead of
# "getaddrinfo()", uncomment the following line:
#USE_DEPRECATED_GETHOSTBYNAME = -DUSE_GETHOSTBYNAME=1
...
COMPILE_OPTS =		$(INCLUDES) $(cdebug) $(cflags) $(cvarsdll) -I. -I"$(TOOLS32)\include" -DNO_OPENSSL=1 $(USE_DEPRECATED_GETHOSTBYNAME)
C =			c
